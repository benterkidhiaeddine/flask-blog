...
from . import app,db
from .forms import LoginForm,RegisterForm,EditPersonalInfoForm,EmptyForm
...
def user_profile(username):
    ...
    return render_template('profile.html',posts = posts,title =title , user = user, form = form)
